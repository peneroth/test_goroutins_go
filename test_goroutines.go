...
// go build -v -ldflags="-X main.version=$(git describe --always --long --dirty)" ./test_goroutines.go
// go build -v -ldflags="-X main.version=$(git describe --always)" ./test_goroutines.go
